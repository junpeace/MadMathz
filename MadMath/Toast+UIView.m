...
- (void)makeToastActivity:(id)position:(float)alpha {
    ...
    UIView *activityContainer = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 330, 470)];
    ...
    if (kDisplayShadow) {
        ...
        [activityContainer.layer setShadowOpacity:0.3];
    ...
    [activityContainer setAlpha:alpha];
